...
# 所有目标文件
OBJS = $(MAIN_OBJ) $(ASTPRINTER_OBJ) $(SEMANTIC_OBJ) $(IRGENERATE_OBJ) $(IRTRANSLATER_OBJ) $(REGISTER_ALLOCATOR_OBJ) $(SSA_TRANSFORM_OBJ) $(SSA_OPTIMIZER_OBJ) $(SSA_DESTROYER_OBJ) $(LEX_OBJ) $(PARSER_OBJ) 
