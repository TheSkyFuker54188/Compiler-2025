...
define i32 @sub(void %r0,void %r0,void %r2,void %r1,void %r4,void %r2,void %r6,void %r3,void %r8)
{
L1:  
    %r10 = load i32, ptr %r9
...
L6:  
    %r27 = alloca i32
    %r26 = call i32 @sub(void %r17,void %r18,void %r19,void %r20,void %r21,void %r22,void %r23,void %r24,void %r25)
